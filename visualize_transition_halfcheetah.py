...
# base_path = '/dysData/DISCOVER/nhy/cqm/ddit/logs/2024-05-10-06-45-50_walker2d-medium-replay-v2_Gen_Nattn2_tadd0.5_tde0.5_gensourcesim_ntype=gaussian_cs-1_hori=20_dgap=gravityx2.0_crossTrue_Version=sar_dim_cross_aln_v7-er16_initcTrue_goalcFalse_returncFalse_seTrue_r15.0_sim1.0_et1_sd42_alladaln/diffuser_inv_d4rl/walker2d-medium-replay-v2/h_20-r_1200.0/100/SDEdit'
...
plt.title('HC-MR', fontsize=28)
plt.savefig('distribution_hc.png', dpi=400)