...
ax_main.set_xlabel('velocity of Tip along X-axis', fontsize=24)
ax_main.set_ylabel('Torque Applied on Back Foot Rotor', fontsize=24)
...
plt.tight_layout()
plt.savefig('z_pdf_2_hc.png',dpi=400)        
# for i in range(25):
#     # ipdb.set_trace()
